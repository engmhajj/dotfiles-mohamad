...
<a href="https://dotfyle.com/mohamad/dotfiles-latest-neovim-neobean">
  <img
    src="https://dotfyle.com/mohamad/dotfiles-latest-neovim-neobean/badges/plugins?style=flat"
    alt="plugins"
  />
</a>
<br>
<a href="https://dotfyle.com/mohamad/dotfiles-latest-neovim-neobean">
  <img src="https://dotfyle.com/mohamad/dotfiles-latest-neovim-neobean/badges/leaderkey?style=flat"
    alt="leaderkey"
  />
</a>
<br>
<a href="https://dotfyle.com/mohamad/dotfiles-latest-neovim-neobean">
  <img src="https://dotfyle.com/mohamad/dotfiles-latest-neovim-neobean/badges/plugin-manager?style=flat"
    alt="plugin-manager"
  />
</a>
...
```bash
# instead of this:
NVIM_APPNAME=mohamad/dotfiles-latest/neovim/neobean nvim

# You would run this:
NVIM_APPNAME=mohamad/dotfiles-latest/neovim/neobean /opt/homebrew/bin/nvim
```

- You can create an alias in your `.bashrc` or `.zshrc` file, just add this

```bash
alias neobean='NVIM_APPNAME=mohamad/dotfiles-latest/neovim/neobean nvim'
```
...
```sh
git clone git@github.com:mohamad/dotfiles-latest ~/.config/mohamad/dotfiles-latest
```
...
\- \[Share a tip here\]\(https:\/\/ko\-fi\.com\/mohamad\)\{:target="\\_blank"\}
\{: .prompt-tip \}
...
- You want to find out why\? More info in my article:
  - \[How I use 1password to keep all my accounts safe\]\(https:\/\/chirpy.home.mohamad.com\/posts\/1password\/1password\/\)\{:target="\\_blank"\}
...
- To each dir in which you want the settings to be applied, for example, I
  copied it to my `github/obsidian_main` and `github/mohamad.github.io` dir.
...
- Executable: /Users/mohamad/.venvs/neovim/bin/python
...
```bash
test comment
mohamad.@.mini~/.luarocks/share/lua/5.1/magick/wand via 🌙 v5.4.6
...
```bash
mohamad.@.mini/opt/homebrew/lib on  master via 🌙 via  v22.2.0
...
Error: "/Users/mohamad/.luarocks/share/lua/5.1/magick/wand/lib.lua:220: Failed to load ImageMagick (MagickWand)"
```
...
Configuration:
   ...
   Configuration files:
      ...
      User    : /Users/mohamad/.luarocks/config-5.4.lua (not found)

   Rocks trees in use:
      /Users/mohamad/.luarocks ("user")
      /opt/homebrew ("system")
```
...
magick 1.6.0-1 is now installed in /Users/mohamad/.luarocks (license: MIT)
```
...
```bash
mohamad.@.mini~/github/obsidian_main on  main [!] took 2s
...
magick
   1.6.0-1 (installed) - /Users/mohamad/.luarocks/lib/luarocks/rocks-5.1
```
