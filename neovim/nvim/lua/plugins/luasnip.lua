...
return {
  ...
  opts = function(_, opts)
    ...
    table.insert(
      ...
      s({
        trig = "dotfileslatest",
        name = "Adds -> [my dotfiles](https://github.com/engmhajj/dotfiles-mohamad)",
        desc = "Add link to https://github.com/engmhajj/dotfiles-mohamad",
      }, {
        t("[my dotfiles](https://github.com/engmhajj/dotfiles-mohamad)"),
      })
    )
    ...
    table.insert(
      ...
      s({
        ...
        t({
          ...
          "☕ Support me -> https://ko-fi.com/mohamad",
          "☑ My Twitter -> https://x.com/link_arzu",
          "❤‍🔥 My tiktok -> https://www.tiktok.com/@mohamad",
          "My dotfiles (remember to star them) -> https://github.com/engmhajj/dotfiles-mohamad",
          "A link to my resume -> https://mohamadelhajhassan.netlify.app/",
        }),
      })
    )
    ...
    table.insert(
      ...
      s({
        ...
        t({
          ...
          "",
          '- If you want to share a tip, you can [donate here](https://ko-fi.com/mohamad/goal?g=6){:target="_blank"}',
          ...
          '- [TikTok](https://www.tiktok.com/@mohamad){:target="_blank"}',
          '- [Instagram](https://www.instagram.com/link_arzu){:target="_blank"}',
          '- [GitHub](https://github.com/mohamad){:target="_blank"}',
          '- [Threads](https://www.threads.net/@link_arzu){:target="_blank"}',
          '- [OnlyFans 🍆](https://mohamad.com/assets/img/imgs/250126-whyugae.avif){:target="_blank"}',
          '- [YouTube (subscribe MF, subscribe)](https://www.youtube.com/@mohamad){:target="_blank"}',
          '- [Ko-Fi](https://ko-fi.com/mohamad/goal?g=6){:target="_blank"}',
          "",
          ...
          '  - [How I use 1password to keep all my accounts safe](https://mohamad.com/posts/1password/1password/){:target="_blank"}',
    ...
    table.insert(
      ...
      s({
        ...
        t("[my dotfiles](https://github.com/mohamad/dotfiles-latest)"),
        t({
          "",
          "",
          "```txt",
          ...
          "https://ko-fi.com/mohamad",
          "",
          "Follow me on twitter",
          "https://x.com/link_arzu",
          "",
          "My dotfiles (remember to star them)",
          "https://github.com/mohamad/dotfiles-latest",
          "",
          ...
          "My dotfiles (remember to star them) -> https://github.com/mohamad/dotfiles-latest",
          "A link to my resume -> https://resume.mohamad.com/",
          "```",
          "",
        }),
      })
