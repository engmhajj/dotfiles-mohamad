...
:DB mysql://root:pass@mysql.home.mohamad.com:3310 SHOW DATABASES;

https://github.com/kristijanhusak/vim-dadbod-ui
To add a new dtabase, toggle DBUI, then hit capital `A` to add a new connection
mysql://root:pass@mysql.home.mohamad.com:3310
mysql://root:pass@mariadb.home.mohamad.com:3309/
postgres://postgres:pass@postgres.home.mohamad.com:5432/
