...
return {
  ...
  init = function()
    local colorInline_bg = colors["mohamad_color02"]
    local color_fg = colors["mohamad_color26"]
    -- local color_sign = "#ebfafa"
    if vim.g.md_heading_bg == "transparent" then
      -- Define color variables
      local color1_bg = colors["mohamad_color04"]
      local color2_bg = colors["mohamad_color02"]
      local color3_bg = colors["mohamad_color03"]
      local color4_bg = colors["mohamad_color01"]
      local color5_bg = colors["mohamad_color05"]
      local color6_bg = colors["mohamad_color08"]
      local color_fg1 = colors["mohamad_color18"]
      local color_fg2 = colors["mohamad_color19"]
      local color_fg3 = colors["mohamad_color20"]
      local color_fg4 = colors["mohamad_color21"]
      local color_fg5 = colors["mohamad_color22"]
      local color_fg6 = colors["mohamad_color23"]
      ...
      local color1_bg = colors["mohamad_color18"]
      local color2_bg = colors["mohamad_color19"]
      local color3_bg = colors["mohamad_color20"]
      local color4_bg = colors["mohamad_color21"]
      local color5_bg = colors["mohamad_color22"]
      local color6_bg = colors["mohamad_color23"]
