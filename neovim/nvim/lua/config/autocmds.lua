...
--     local active_bg = colors.mohamad_color10 -- darker background
--     local inactive_bg = colors.mohamad_color07 -- brighter background
...
--     vim.cmd("hi CursorLine guibg=" .. colors.mohamad_color13)
