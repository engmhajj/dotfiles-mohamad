-- ~/.config/dotfiles/dotfiles-latest/neovim/neobean/lua/config/colors.lua
...
local function load_colors()
  local colors = {}
  local active_file = os.getenv("HOME") .. "/.config/dotfiles/dotfiles-latest/neovim/nvim/lua/config/active-colorscheme.sh"
